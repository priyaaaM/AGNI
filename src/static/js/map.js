document.addEventListener("DOMContentLoaded", () => {
    ...
    predictBtn.addEventListener('click', async () => {
        ...
        satellitePredictionResult.textContent = satelliteStatus ? 'THERE IS A WILDFIRE ' : 'THERE IS NO WILDFIRE ';
        ...
        // weatherPredictionResult.textContent = weatherStatus ? 'THERE IS A WILDFIRE ' : 'THERE IS NO WILDFIRE ';
        ...
        combinedPredictionResult.textContent = averageStatus ? 'THERE IS A WILDFIRE ' : 'THERE IS NO WILDFIRE ';
